  ...
  return (
    <div className='robot-container'>
      ...
      <div className='robot-grid'>
        ...
        <p>
          I worked on this robot in my Controls class with a group of peers
          seeking to better understand and create an autonomous vehicle system.
          Our project specifically is designed to detect and avoid the edges of
          a table as it wanders across it. It makes use of an ultrasonic sensor
